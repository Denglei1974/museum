...
import { getThemeByRole, isPublishAdmin } from "@/lib/auth/roles";
    ...
    <div className="min-h-screen" style={{ backgroundColor: theme.bg }}>
      <header className="text-white p-4 shadow-lg" style={{ backgroundColor: theme.primary }}>
        <div className="max-w-4xl mx-auto flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold">招募管理</h1>
        </div>
      </header>
      <main className="max-w-4xl mx-auto p-4">
        <AdminRecruitmentsClient theme={theme} canPublish={isPublishAdmin(user.role)} />
      </main>
    </div>
  );
}
